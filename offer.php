...
<title>Payou – <?php echo htmlspecialchars($offer['title']); ?></title>
...
<nav class="navbar">
  ...
  <div style="width:74px;display:flex;justify-content:flex-end;">
    <a href="admin.php?edit=<?php echo $offer['id']; ?>" style="width:36px;height:36px;border-radius:50%;background:var(--primary-light);display:flex;align-items:center;justify-content:center;color:var(--primary);cursor:pointer;text-decoration:none;">
      <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" width="18" height="18"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
    </a>
  </div>
</nav>
      ...
      <div class="timeline">
        ...
        <div class="tl-item done">
          ...
          <div class="tl-body">
            ...
            <div class="tl-time"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg> Instant</div>
          </div>
        </div>
        <div class="tl-item">
          <div class="tl-left">
        ...
        <div class="tl-item">
          ...
          <div class="tl-body">
            ...
            <div class="tl-time"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg> 24–48 hrs</div>
          </div>
        </div>
        <?php else: ?>
          ...
          <div class="tl-item <?php echo $step['is_completed'] ? 'done' : ''; ?>">
            ...
            <div class="tl-body">
              ...
              <div class="tl-time"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg> <?php echo htmlspecialchars($step['step_time']); ?></div>
              <?php endif; ?>
            </div>
          </div>
          <?php endforeach; ?>
