...
<head>
  ...
  <style>
    ...
    *::after {
    ...
    .promo-card.salmon {
      background: linear-gradient(135deg, rgba(255, 240, 235, 0.9) 0%, rgba(255, 214, 200, 0.9) 100%);
    }

    .promo-card.mint {
      background: linear-gradient(135deg, rgba(232, 253, 244, 0.9) 0%, rgba(199, 246, 227, 0.9) 100%);
    }

    .promo-card.lavender {
      background: linear-gradient(135deg, rgba(240, 238, 255, 0.9) 0%, rgba(221, 214, 255, 0.9) 100%);
    }
    ...
    .expire-card:nth-child(1) {
      animation-delay: 0.3s;
    }

    .expire-card:nth-child(2) {
      animation-delay: 0.35s;
    }

    .expire-card:nth-child(3) {
      animation-delay: 0.4s;
    }

    .expire-card:nth-child(4) {
      animation-delay: 0.45s;
    }

    .expire-card:nth-child(5) {
        ...
        <?php if (!empty($banners)): ?>
          <div class="promo-scroll">
            ...
            <?php foreach ($banners as $index => $banner): ?>
              <div class="promo-card <?php echo $colors[$index % 4]; ?>" style="padding:0;overflow:hidden;width:100%;max-width:100%;min-width:100%;max-height:150px">
                <?php if (!empty($banner['link_url'])): ?>
                  <a href="<?php echo htmlspecialchars($banner['link_url']); ?>" target="_blank" style="display:block;width:100%;height:100%;max-width:150px;">
